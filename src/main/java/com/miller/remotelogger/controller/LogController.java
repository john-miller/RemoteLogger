...
public interface LogController {
	...
	public LogEvent getLogEventById(@PathVariable("logId") int logId) throws LogEventNotFoundException;

	@PreAuthorize("hasRole('ADMIN')")
	@ResponseStatus(HttpStatus.OK)
	@RequestMapping(value = "/{logId}", method = RequestMethod.DELETE)
	public LogEvent deleteLogEventById(@PathVariable int logId) throws LogEventNotFoundException;

	@PreAuthorize("hasRole('EDITOR') or hasRole('ADMIN')")
	@JsonView(LogEvent.ResponseView.class)
	@ResponseStatus(HttpStatus.OK)
	@RequestMapping(value="/", method = RequestMethod.POST)
	public LogEvent addLogEvent(@RequestBody LogEvent logEvent) throws TableNotFoundException, LogEventNotFoundException;
